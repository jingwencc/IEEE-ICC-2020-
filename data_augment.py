...
tf.flags.DEFINE_integer('num_steps_run', 3, 'Number of steps to run per this script call')
...
def _plot(samples, step):
    ...
    for i, sample in enumerate(samples):
	    if i % 10 == 0:
		    plt.savefig('/home/jingwezh/Data/CGAN/cgan_step_%d_number_%d.png' %(step,i))
	    elif i % 10 == 1:
		    plt.savefig('/home/jingwezh/Data/CGAN/cgan_step_%d_number_%d.png' %(step,i))
	    elif i % 10 == 2:
		    plt.savefig('/home/jingwezh/Data/CGAN/cgan_step_%d_number_%d.png' %(step,i))
